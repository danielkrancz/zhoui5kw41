		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#atclouddnastudent00zhoui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"atclouddnastudent00zhoui5-display": {
								"semanticObject": "atclouddnastudent00zhoui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=at.clouddna.student00.zhoui5",
									"url": sap.ui.require.toUrl("at/clouddna/student00/zhoui5")
								}
							}
						}
					}
